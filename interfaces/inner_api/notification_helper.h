...
public:
     ...
     */
    static ErrCode UpdateInnerConfig(const std::string &configKey, const std::string &configValue);
     ...
     */
    static ErrCode IsPriorityIntelligentEnabled(bool &enabled);
     ...
     */
    static ErrCode SetPriorityIntelligentEnabled(const bool enabled);
     ...
     */
    static ErrCode GetPriorityStrategyByBundles(const std::vector<NotificationBundleOption> &bundleOptions,
     ...
     */
    static ErrCode SetPriorityStrategyByBundles(const std::map<sptr<NotificationBundleOption>, int64_t> &strategies);
