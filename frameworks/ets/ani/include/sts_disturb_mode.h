...
#ifndef OHOS_DISTRIBUTED_NOTIFICATION_SERVER_STS_DISTURB_MODE_H
#define OHOS_DISTRIBUTED_NOTIFICATION_SERVER_STS_DISTURB_MODE_H
#include "ani.h"

#include "notification_do_not_disturb_profile.h"

using NotificationDoNotDisturbProfile = OHOS::Notification::NotificationDoNotDisturbProfile;
namespace OHOS {
