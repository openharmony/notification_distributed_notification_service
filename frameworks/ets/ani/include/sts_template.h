...
#ifndef OHOS_DISTRIBUTED_NOTIFICATION_SERVER_STS_TEMPLATE_H
#define OHOS_DISTRIBUTED_NOTIFICATION_SERVER_STS_TEMPLATE_H
#include "ani.h"
#include "notification_template.h"

namespace OHOS {
namespace NotificationSts {
using NotificationTemplate = OHOS::Notification::NotificationTemplate;
