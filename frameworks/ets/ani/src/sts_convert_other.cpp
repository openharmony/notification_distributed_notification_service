...
ani_object GetAniResource(ani_env *env, const std::shared_ptr<ResourceManager::Resource> &resource)
{
    ...
    if (!CreateClassObjByClassName(env,
        ...
        deletePoint(resourceCls);
        deletePoint(resourceObject);
        return nullptr;
    }
