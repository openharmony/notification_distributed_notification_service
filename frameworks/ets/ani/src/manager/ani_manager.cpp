...
static std::array kitManagerFunctions = {
    ...
    ani_native_function {"nativeGetBadgeNumber", ":l", reinterpret_cast<void *>(AniGetBadgeNumber)},
    ani_native_function {"nativeSetBadgeNumber", "i:", reinterpret_cast<void *>(AniSetBadgeNumber)},
