...
extern const std::string VOICE_BROADCAST_CONFIG_RULE_KEY;
extern const std::string LIVE_VIEW_SHARE_FUNC_SWITCH_KEY;
extern const std::string EXTENDINFO_CREATE_TIME;
