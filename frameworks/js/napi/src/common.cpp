    ...
    const napi_env &env, const napi_value &value, NotificationRequest &request)
{
    ...
    if (hasProperty) {
        napi_get_named_property(env, value, "trigger", &result);
        NAPI_CALL(env, napi_typeof(env, result, &valuetype));
        if (valuetype != napi_object) {
            ANS_LOGE("Wrong argument type. Object expected.");
    ...
    std::shared_ptr<NotificationTrigger> &notificationTrigger)
{
    ...
    napi_get_named_property(env, value, "displayTime", &result);
    NAPI_CALL(env, napi_typeof(env, result, &valuetype));
    if (valuetype != napi_number) {
        ANS_LOGE("Wrong argument type. Number expected.");
    ...
    std::shared_ptr<NotificationTrigger> &notificationTrigger)
{
    ...
    napi_get_named_property(env, value, "condition", &result);
    NAPI_CALL(env, napi_typeof(env, result, &valuetype));
    if (valuetype != napi_object) {
        ANS_LOGE("Wrong argument type. Object expected.");
    ...
    std::shared_ptr<NotificationGeofence> &geofence)
{
    ...
    napi_get_named_property(env, value, "coordinateSystemType", &result);
    NAPI_CALL(env, napi_typeof(env, result, &valuetype));
    if (valuetype != napi_number) {
    ...
    std::shared_ptr<NotificationGeofence> &geofence)
{
    ...
    napi_get_named_property(env, value, "monitorEvent", &result);
    NAPI_CALL(env, napi_typeof(env, result, &valuetype));
    if (valuetype != napi_number) {
        ANS_LOGE("Wrong argument type. Number expected.");
