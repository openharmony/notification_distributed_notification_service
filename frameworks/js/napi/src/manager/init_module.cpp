...
napi_value NotificationManagerInit(napi_env env, napi_value exports)
{
    ...
    napi_property_descriptor desc[] = {
        ...
        DECLARE_NAPI_FUNCTION("setDistributedBundleOption", NapiSetDistributedBundleOption),
        ...
        DECLARE_NAPI_FUNCTION("setDistributedBundleOption", Common::NapiReturnCapErr),
