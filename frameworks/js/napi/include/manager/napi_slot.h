...
napi_value Napi_AddSlot(napi_env env, napi_callback_info info);
napi_value Napi_AddSlots(napi_env env, napi_callback_info info);
napi_value Napi_SetSlotByBundle(napi_env env, napi_callback_info info);
napi_value Napi_GetSlot(napi_env env, napi_callback_info info);
napi_value Napi_GetSlotNumByBundle(napi_env env, napi_callback_info info);
napi_value Napi_GetSlots(napi_env env, napi_callback_info info);
napi_value Napi_GetSlotsByBundle(napi_env env, napi_callback_info info);
napi_value Napi_RemoveSlot(napi_env env, napi_callback_info info);
napi_value Napi_RemoveAllSlots(napi_env env, napi_callback_info info);
napi_value Napi_EnableNotificationSlot(napi_env env, napi_callback_info info);
napi_value Napi_IsEnableNotificationSlot(napi_env env, napi_callback_info info);
