...
#include "service_setusergrantedbundlestate_fuzzer.h"
...
bool DoSomethingInterestingWithMyAPI(FuzzedDataProvider *fuzzData)
{
    ...
    int bundleCount = fuzzData->ConsumeIntegralInRange<int>(0, 5);
    ...
    NotificationHelper::SetUserGrantedBundleState(*targetBundle, enabledBundles, enabled);
