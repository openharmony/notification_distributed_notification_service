 ...
 */
#include "service_getnotificationswitch_fuzzer.h"
...
namespace Notification {
    bool DoSomethingInterestingWithMyAPI(FuzzedDataProvider *fuzzData)
    {
        ...
        sptr<NotificationBundleOption> bundleOption = sptr<NotificationBundleOption>::MakeSptr();
        if (bundleOption == nullptr) {
            return false;
        }
        bundleOption->SetBundleName(stringData);
        int32_t uidDefaultValue = 0;
