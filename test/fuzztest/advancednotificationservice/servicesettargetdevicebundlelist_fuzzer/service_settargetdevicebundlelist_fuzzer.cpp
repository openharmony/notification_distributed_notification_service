 ...
 */
#include "service_settargetdevicebundlelist_fuzzer.h"
...
namespace Notification {
    bool DoSomethingInterestingWithMyAPI(FuzzedDataProvider *fuzzData)
    {
        ...
        int32_t operatorType = fuzzData->ConsumeIntegral<int32_t>();
        std::vector<std::string> bundleList;
        std::vector<std::string> labelList;
        service->SetTargetDeviceBundleList(deviceType, deviceId, operatorType, bundleList, labelList);
        return true;
    }
}
}
