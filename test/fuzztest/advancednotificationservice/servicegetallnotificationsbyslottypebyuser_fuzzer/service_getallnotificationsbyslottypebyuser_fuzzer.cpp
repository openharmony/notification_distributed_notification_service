 ...
 */
#include "service_getallnotificationsbyslottypebyuser_fuzzer.h"
...
namespace Notification {
    bool DoSomethingInterestingWithMyAPI(FuzzedDataProvider *fuzzData)
    {
        ...
        sptr<Notification> notification = ObjectBuilder<Notification>::Build(fuzzData);
        std::vector<sptr<Notification>> notifications = { notification };
        service->GetAllNotificationsBySlotType(notifications, intData, userId);
        return true;
    }
}
}
