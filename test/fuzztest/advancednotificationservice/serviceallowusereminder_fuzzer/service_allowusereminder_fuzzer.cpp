...
namespace Notification {
    bool DoSomethingInterestingWithMyAPI(FuzzedDataProvider *fuzzData)
    {
        ...
        bool allow = fuzzData->ConsumeBool();
        service->AllowUseReminder(bundleName);
        service->AllowUseReminder(bundleName, userId);
        service->AllowUseReminder(bundleName, allow);
        service->AllowUseReminder(bundleName, userId, allow);
        return true;
    }
}
}
