 ...
 */
#include "service_settargetdeviceswitch_fuzzer.h"
...
namespace Notification {
    bool DoSomethingInterestingWithMyAPI(FuzzedDataProvider *fuzzData)
    {
        ...
        bool notificaitonEnable = fuzzData->ConsumeBool();
        bool liveViewEnable = fuzzData->ConsumeBool();
        service->SetTargetDeviceSwitch(deviceType, deviceId, notificaitonEnable, liveViewEnable);
        return true;
    }
}
}
