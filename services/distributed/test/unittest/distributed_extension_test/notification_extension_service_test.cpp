...
/**
 * @tc.name: SubscribeNotification_NullBundle_00001
 * @tc.desc: Test SubscribeNotification with null bundle parameter
 * @tc.type: FUNC
 * @tc.require: I00001
 */
HWTEST_F(NotificationExtensionServiceTest, SubscribeNotification_NullBundle_00001, Function | SmallTest | Level1)
{
    auto& subscribeService = ExtensionServiceSubscribeService::GetInstance();
    sptr<NotificationBundleOption> nullBundle = nullptr;
    std::vector<sptr<NotificationBundleOption>> subscribedBundles;
    
    size_t initialSize = subscribeService.subscriberMap_.size();
    subscribeService.SubscribeNotification(nullBundle, subscribedBundles);
    EXPECT_EQ(subscribeService.subscriberMap_.size(), initialSize);
}

/**
 * @tc.name: SubscribeNotification_EmptyBundles_00001
 * @tc.desc: Test SubscribeNotification with empty subscribedBundles vector
 * @tc.type: FUNC
 * @tc.require: I00001
 */
HWTEST_F(NotificationExtensionServiceTest, SubscribeNotification_EmptyBundles_00001, Function | SmallTest | Level1)
{
    auto& subscribeService = ExtensionServiceSubscribeService::GetInstance();
    ...
    size_t initialSize = subscribeService.subscriberMap_.size();
    subscribeService.SubscribeNotification(bundle, emptyBundles);
    EXPECT_EQ(subscribeService.subscriberMap_.size(), initialSize);
}

/**
 * @tc.name: SubscribeNotification_NullSubscribeBundle_00001
 * @tc.desc: Test SubscribeNotification with nullptr element in subscribedBundles
 * @tc.type: FUNC
 * @tc.require: I00001
 */
HWTEST_F(NotificationExtensionServiceTest,
    SubscribeNotification_NullSubscribeBundle_00001, Function | SmallTest | Level1)
{
    auto& subscribeService = ExtensionServiceSubscribeService::GetInstance();
    sptr<NotificationBundleOption> bundle = new NotificationBundleOption("testBundle", 100);
    std::vector<sptr<NotificationBundleOption>> bundles;
    bundles.push_back(nullptr);
    
    size_t initialSize = subscribeService.subscriberMap_.size();
    subscribeService.SubscribeNotification(bundle, bundles);
    EXPECT_EQ(subscribeService.subscriberMap_.size(), initialSize);
}

/**
 * @tc.name: UnsubscribeNotification_NullBundle_00001
 * @tc.desc: Test UnsubscribeNotification with null bundle parameter
 * @tc.type: FUNC
 * @tc.require: I00001
 */
HWTEST_F(NotificationExtensionServiceTest, UnsubscribeNotification_NullBundle_00001, Function | SmallTest | Level1)
{
    auto& subscribeService = ExtensionServiceSubscribeService::GetInstance();
    sptr<NotificationBundleOption> nullBundle = nullptr;
    
    size_t initialSize = subscribeService.subscriberMap_.size();
    subscribeService.UnsubscribeNotification(nullBundle);
    EXPECT_EQ(subscribeService.subscriberMap_.size(), initialSize);
}

/**
 * @tc.name: GetConnection_NullSubscriberInfo_00001
 * @tc.desc: Test GetConnection with null subscriberInfo parameter
 * @tc.type: FUNC
 * @tc.require: I00001
 */
HWTEST_F(NotificationExtensionServiceTest, GetConnection_NullSubscriberInfo_00001, Function | SmallTest | Level1)
{
    auto& connectionService = ExtensionServiceConnectionService::GetInstance();
    std::shared_ptr<ExtensionSubscriberInfo> nullInfo = nullptr;
    
    auto connection = connectionService.GetConnection(nullInfo);
    EXPECT_EQ(connection, nullptr);
}

/**
 * @tc.name: CloseConnection_OnAllClosedCallback_00001
 * @tc.desc: Test onAllConnectionsClosed callback triggered when connectionMap becomes empty
 * @tc.type: FUNC
 * @tc.require: I00001
 */
HWTEST_F(NotificationExtensionServiceTest, CloseConnection_OnAllClosedCallback_00001, Function | SmallTest | Level1)
{
    auto& connectionService = ExtensionServiceConnectionService::GetInstance();
    bool callbackCalled = false;
    
    connectionService.SetOnAllConnectionsClosed([&callbackCalled]() {
        callbackCalled = true;
    });
    ...
    subscriberInfo.bundleName = "testBundle";
    subscriberInfo.extensionName = "testExtension";
    subscriberInfo.uid = 100;
    subscriberInfo.userId = 100;
    
    auto connection = connectionService.GetConnection(std::make_shared<ExtensionSubscriberInfo>(subscriberInfo));
    EXPECT_NE(connection, nullptr);
    
    connectionService.CloseConnection(subscriberInfo);
...
/**
 * @tc.name: RemoveConnection_OnAllClosedCallback_00001
 * @tc.desc: Test onAllConnectionsClosed callback triggered after RemoveConnection
 * @tc.type: FUNC
 * @tc.require: I00001
 */
HWTEST_F(NotificationExtensionServiceTest, RemoveConnection_OnAllClosedCallback_00001, Function | SmallTest | Level1)
{
    auto& connectionService = ExtensionServiceConnectionService::GetInstance();
    bool callbackCalled = false;
    ...
    subscriberInfo.bundleName = "testBundle2";
    subscriberInfo.extensionName = "testExtension2";
    subscriberInfo.uid = 101;
    subscriberInfo.userId = 101;
    
    auto connection = connectionService.GetConnection(std::make_shared<ExtensionSubscriberInfo>(subscriberInfo));
    EXPECT_NE(connection, nullptr);
    
    connectionService.RemoveConnection(subscriberInfo);
