...
#ifndef BASE_NOTIFICATION_DISTRIBUTED_NOTIFICATION_SCREENLOCK_SERVICE_H
#define BASE_NOTIFICATION_DISTRIBUTED_NOTIFICATION_SCREENLOCK_SERVICE_H
...
public:
    static ScreenLockService& GetInstance();
    int32_t IsScreenLocked();
private:
    ScreenLockService();
    ~ScreenLockService() = default;
