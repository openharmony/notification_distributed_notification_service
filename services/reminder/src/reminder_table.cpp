...
void ReminderBaseTable::InitDbColumns()
{
    ...
    AddColumn(CREATOR_UID, "INT NOT NULL", ADD_COLUMNS, SELECT_COLUMNS);
    AddColumn(TIME_ZONE_TYPE, "INT NOT NULL", ADD_COLUMNS, SELECT_COLUMNS);
    AddColumnEnd(NOTIFICATION_REQUEST_PROXY, "TEXT", ADD_COLUMNS, SELECT_COLUMNS);
}
