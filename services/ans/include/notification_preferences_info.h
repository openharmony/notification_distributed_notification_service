...
public:
    ...
    public:
        ...
        int32_t GetExtensionSubscriptionNotificationStrategy() const;
        void SetExtensionSubscriptionNotificationStrategy(int32_t strategy);
    private:
        ...
        int32_t extensionSubscriptionNotificationStrategy_ = 0;
    };
