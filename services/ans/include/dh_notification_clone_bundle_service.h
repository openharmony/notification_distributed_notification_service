...
#ifndef BASE_NOTIFICATION_DISTRIBUTED_NOTIFICATION_SERVICE_SERVICES_ANS_INCLUDE_DH_NOTIFICATION_CLONE_BUNDLE_H
...
class DhNotificationCloneBundle final : public NotificationCloneTemplate {
public:
    DhNotificationCloneBundle();
    ~DhNotificationCloneBundle() override;
...
private:
    ...
    std::shared_ptr<ffrt::queue> dhCloneBundleQueue_ = nullptr;
    ffrt::mutex lock_;
};
} // namespace Notification
} // namespace OHOS
#endif  // BASE_NOTIFICATION_DISTRIBUTED_NOTIFICATION_SERVICE_SERVICES_ANS_INCLUDE_DH_NOTIFICATION_CLONE_BUNDLE_H
