...
ErrCode DisturbManager::HandleAddDoNotDisturbProfiles(MessageParcel &data, MessageParcel &reply)
{
    ...
    ErrCode result = AddDoNotDisturbProfilesSyncQueue(profiles);
...
ErrCode DisturbManager::AddDoNotDisturbProfilesSyncQueue(
