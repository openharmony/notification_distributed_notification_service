...
class RdbStoreTest : public RdbStore {
    public:
        ...
        virtual int RegisterAutoSyncCallback(std::shared_ptr<RdbSyncObserver> syncObserver)
        {
            return E_ERROR;
        };

        virtual int UnRegisterAutoSyncCallback(std::shared_ptr<RdbSyncObserver> syncObserver)
        {
            return E_ERROR;
        };
