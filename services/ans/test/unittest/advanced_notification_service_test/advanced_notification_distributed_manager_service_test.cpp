...
/**
 * @tc.name: SetSmartReminderEnabled_00001
 * @tc.desc: Test SetSmartReminderEnabled when caller is not system app
 * @tc.type: FUNC
 * @tc.require: issue
 */
HWTEST_F(AdvancedNotificationDistMgrServiceTest, SetSmartReminderEnabled_00001, Function | SmallTest | Level1)
{
    MockGetTokenTypeFlag(ATokenTypeEnum::TOKEN_HAP);
    MockIsSystemApp(false);
...
/**
 * @tc.name: SetSmartReminderEnabled_00002
 * @tc.desc: Test SetSmartReminderEnabled when permission denied
 * @tc.type: FUNC
 * @tc.require: issue
 */
HWTEST_F(AdvancedNotificationDistMgrServiceTest, SetSmartReminderEnabled_00002, Function | SmallTest | Level1)
{
    MockGetTokenTypeFlag(ATokenTypeEnum::TOKEN_NATIVE);
    MockIsSystemApp(true);
    MockIsVerfyPermisson(false);
...
/**
 * @tc.name: SetSmartReminderEnabled_00003
 * @tc.desc: Test SetSmartReminderEnabled successfully
 * @tc.type: FUNC
 * @tc.require: issue
 */
HWTEST_F(AdvancedNotificationDistMgrServiceTest, SetSmartReminderEnabled_00003, Function | SmallTest | Level1)
{
    MockGetTokenTypeFlag(ATokenTypeEnum::TOKEN_NATIVE);
    MockIsSystemApp(true);
    MockIsVerfyPermisson(true);
...
/**
 * @tc.name: IsSmartReminderEnabled_00001
 * @tc.desc: Test IsSmartReminderEnabled when caller is not system app
 * @tc.type: FUNC
 * @tc.require: issue
 */
HWTEST_F(AdvancedNotificationDistMgrServiceTest, IsSmartReminderEnabled_00001, Function | SmallTest | Level1)
{
    MockGetTokenTypeFlag(ATokenTypeEnum::TOKEN_HAP);
    MockIsSystemApp(false);
    std::string deviceType = "tablet";
...
/**
 * @tc.name: IsSmartReminderEnabled_00002
 * @tc.desc: Test IsSmartReminderEnabled when permission denied
 * @tc.type: FUNC
 * @tc.require: issue
 */
HWTEST_F(AdvancedNotificationDistMgrServiceTest, IsSmartReminderEnabled_00002, Function | SmallTest | Level1)
{
    MockGetTokenTypeFlag(ATokenTypeEnum::TOKEN_NATIVE);
    MockIsSystemApp(true);
    MockIsVerfyPermisson(false);
...
/**
 * @tc.name: IsSmartReminderEnabled_00003
 * @tc.desc: Test IsSmartReminderEnabled successfully
 * @tc.type: FUNC
 * @tc.require: issue
 */
HWTEST_F(AdvancedNotificationDistMgrServiceTest, IsSmartReminderEnabled_00003, Function | SmallTest | Level1)
{
    MockGetTokenTypeFlag(ATokenTypeEnum::TOKEN_NATIVE);
    MockIsSystemApp(true);
    MockIsVerfyPermisson(true);
...
/**
 * @tc.name: SetDistributedEnabledForCollaboration_00001
 * @tc.desc: Test SetDistributedEnabledForCollaboration with null bundleOption
 * @tc.type: FUNC
 * @tc.require: issue
 */
HWTEST_F(AdvancedNotificationDistMgrServiceTest, SetDistributedEnabledForCollaboration_00001,
    Function | SmallTest | Level1)
{
    ...
    auto ret = advancedNotificationService_->SetDistributedEnabledForCollaboration(
        bundleOption, deviceType, enabled, isNotification);
    ASSERT_NE(ret, (int)ERR_OK);
}

/**
 * @tc.name: SetDistributedEnabledForCollaboration_00002
 * @tc.desc: Test SetDistributedEnabledForCollaboration with empty bundleName
 * @tc.type: FUNC
 * @tc.require: issue
 */
HWTEST_F(AdvancedNotificationDistMgrServiceTest, SetDistributedEnabledForCollaboration_00002,
    Function | SmallTest | Level1)
{
...
/**
 * @tc.name: SetDistributedBundleOption_00001
 * @tc.desc: Test SetDistributedBundleOption with null bundleOption
 * @tc.type: FUNC
 * @tc.require: issue
 */
HWTEST_F(AdvancedNotificationDistMgrServiceTest, SetDistributedBundleOption_00001, Function | SmallTest | Level1)
{
...
/**
 * @tc.name: SetDistributedBundleOption_00002
 * @tc.desc: Test SetDistributedBundleOption with empty deviceType
 * @tc.type: FUNC
 * @tc.require: issue
 */
HWTEST_F(AdvancedNotificationDistMgrServiceTest, SetDistributedBundleOption_00002, Function | SmallTest | Level1)
{
    std::vector<sptr<DistributedBundleOption>> bundles;
    auto bundle = std::make_shared<NotificationBundleOption>("testBundle", 100);
    sptr<DistributedBundleOption> bundleOption = new DistributedBundleOption(bundle, true);
    bundles.push_back(bundleOption);
    std::string deviceType = "tablet";
...
/**
 * @tc.name: IsDistributedEnabledByBundle_00001
 * @tc.desc: Test IsDistributedEnabledByBundle with null bundleOption
 * @tc.type: FUNC
 * @tc.require: issue
 */
HWTEST_F(AdvancedNotificationDistMgrServiceTest, IsDistributedEnabledByBundle_00001, Function | SmallTest | Level1)
{
    sptr<NotificationBundleOption> bundleOption = nullptr;
    std::string deviceType = "tablet";
    bool isNotification = true;
...
/**
 * @tc.name: IsDistributedEnabledByBundle_00002
 * @tc.desc: Test IsDistributedEnabledByBundle successfully
 * @tc.type: FUNC
 * @tc.require: issue
 */
HWTEST_F(AdvancedNotificationDistMgrServiceTest, IsDistributedEnabledByBundle_00002, Function | SmallTest | Level1)
{
    MockGetTokenTypeFlag(ATokenTypeEnum::TOKEN_NATIVE);
    MockIsSystemApp(true);
    MockIsVerfyPermisson(true);
 ...
 * @tc.desc: Test GetDeviceRemindType when caller is not system app
 * @tc.type: FUNC
 * @tc.require: issue
 */
HWTEST_F(AdvancedNotificationDistMgrServiceTest, GetDeviceRemindType_00001, Function | SmallTest | Level1)
{
    MockGetTokenTypeFlag(ATokenTypeEnum::TOKEN_HAP);
    MockIsSystemApp(false);
...
/**
 * @tc.name: GetDeviceRemindType_00002
 * @tc.desc: Test GetDeviceRemindType when permission denied
 * @tc.type: FUNC
 * @tc.require: issue
 */
HWTEST_F(AdvancedNotificationDistMgrServiceTest, GetDeviceRemindType_00002, Function | SmallTest | Level1)
{
    MockGetTokenTypeFlag(ATokenTypeEnum::TOKEN_NATIVE);
    MockIsSystemApp(true);
    MockIsVerfyPermisson(false);
...
/**
 * @tc.name: ReplyDistributeOperation_00001
 * @tc.desc: Test ReplyDistributeOperation successfully
 * @tc.type: FUNC
 * @tc.require: issue
 */
HWTEST_F(AdvancedNotificationDistMgrServiceTest, ReplyDistributeOperation_00001, Function | SmallTest | Level1)
{
    MockGetTokenTypeFlag(ATokenTypeEnum::TOKEN_NATIVE);
    MockIsSystemApp(true);
    MockIsVerfyPermisson(true);
    std::string hashCode = "testHashCode";
...
/**
 * @tc.name: DistributedEnabledBySlotChangeStrategy_00001
 * @tc.desc: Test DistributedEnabledBySlotChangeStrategy with live view slot
 * @tc.type: FUNC
 * @tc.require: issue
 */
HWTEST_F(AdvancedNotificationDistMgrServiceTest, DistributedEnabledBySlotChangeStrategy_00001,
    Function | SmallTest | Level1)
{
    std::string deviceType = "tablet";
    ...
    advancedNotificationService_->DistributedEnabledBySlotChangeStrategy(deviceType, slotType, enabled, result);
    ASSERT_EQ(result, ERR_OK);
}

/**
 * @tc.name: IsDistributedEnabled_Bool_00001
 * @tc.desc: Test IsDistributedEnabled(bool) successfully
 * @tc.type: FUNC
 * @tc.require: issue
 */
HWTEST_F(AdvancedNotificationDistMgrServiceTest, IsDistributedEnabled_Bool_00001, Function | SmallTest | Level1)
{
    bool enabled = false;
