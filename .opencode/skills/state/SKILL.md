...
- `kb_dir`
- `action: "update_phase"`
- `phase`: "architecture" | "dev_design" | "plan" | "execute" | "build" | "doc"
- `status`: "pending" | "running" | "pending_user_confirmation" | "done" | "blocked"
...
- `current_phase`: "architecture" | "dev_design" | "plan" | "execute" | "build" | "doc" | "completed"
